...
<div class="container px-4 sm:pl-4 sm:pr-4 md:mx-auto mt-5">
    ...
    ?>
    <!-- Featured Article -->
    <div class="flex flex-col mb-5 mx-auto md:w-7/12 bg-slate-50 dark:bg-gray-950">
    ...
    ?>
    <!-- Latest Articles -->
    <div class="flex flex-col mb-5 md:w-7/12 md:mx-auto">
    ...
    ?>
    <!-- Tips & Snippets -->
    <div class="flex flex-col mb-10 md:w-7/12 md:mx-auto">
        <!--  Tips container -->
